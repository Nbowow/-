 ...
 * // 프로필 이미지가 있는 경우
 * return (
 *   <UserProfile imageUrl={"https://example.com/profile.jpg"} size={"6rem"} />
 * )
 *
 * // 프로필 이미지가 없는 경우 (기본 아이콘 표시)
 * return (
 *   <UserProfile size={"4rem"} />
 * )
 *
 * @param {Object} props - UserProfile 컴포넌트의 props
 * @param {string} [props.imageUrl] - 표시할 프로필 이미지의 URL (optional)
 * @param {string} [props.size="5rem"] - 이미지 또는 아이콘의 크기 (optional)
 * @returns {JSX.Element} UserProfile 컴포넌트
 */
